    ...
    return (
        <div className="max-w-6xl mx-auto px-4 py-12">
            ...
            <div className="mt-4 flex flex-col sm:flex-row gap-3">
                ...
                />
                <select value={category} onChange={e => setCategory(e.target.value)} className="border p-2 rounded w-full sm:w-auto">
                ...
                <button
                    ...
                    className="px-3 py-2 bg-brand text-white rounded w-full sm:w-auto"
                >
                    Reset
                </button>
            </div>
